...
import type { OpenRoomInfo } from 'shared';
...
function RoomRow({ room }: { room: OpenRoomInfo }) {
  return (
    <tr className="border-t border-zinc-800 hover:bg-zinc-800/40 transition-colors">
      ...
      <td className="px-4 py-3 text-sm text-zinc-400 font-mono truncate max-w-[140px]">{room.hostNickname}</td>
